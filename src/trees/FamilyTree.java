...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            for (TreeNode child: children)
            {
            	...
            	TreeNode childNode = child.getNodeWithName(targetName);
            	if (childNode != null) {
            		return childNode;
            	}
            }
	...
	private void addLine(String line) throws TreeException
	{
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException("No parent found");
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("node not found in tree"); //Throw a TreeException with a useful message
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("node not found in tree"); // Throw TreeException with a useful message
